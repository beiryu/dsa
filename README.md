...
| [Construct Binary Tree from Inorder and Postorder Traversal](problems/medium/construct-binary-tree-from-inorder-and-postorder-traversal) | Recursion, Hashmap, Postorder Index          | [Solution](problems/medium/construct-binary-tree-from-inorder-and-postorder-traversal/index.md) |
